...
## Helper Command for System Info

The template includes a shell command to generate system information. Run this to get properly formatted system info:
...
- Include macOS version, build, architecture
- Include Xcode version OR Command Line Tools version
